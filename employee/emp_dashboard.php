<?php
// Fix path to go up one folder to reach 'include'
require_once('../include/db_connect.php');

// Start session if not already started in db_connect.php
if (session_status() === PHP_SESSION_NONE) {
    session_start();
}

// FOR TESTING: ID 1 is Arun Kumar
$_SESSION['user_id'] = 1;
...
if (isset($_POST['toggle_attendance'])) {
    ...
    header("Location: emp_dashboard.php?msg=Attendance Updated");
    exit();
}
...
if (isset($_POST['apply_leave'])) {
    ...
    header("Location: emp_dashboard.php?msg=Leave Applied");
    exit();
}
...
<head>
    ...
    <style>
        body { font-family: -apple-system, sans-serif; background-color: #f4f7fc; color: #333; margin: 0; display: flex; }
        
        /* Layout */
        .sidebar-container { width: 250px; position: fixed; height: 100vh; background: #fff; }
