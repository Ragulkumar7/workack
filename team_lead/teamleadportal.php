...
// Team Progress Data
$teamProgress = [
    ['id' => 1, 'name' => 'Arun', 'task' => 'Frontend Integration', 'progress' => 85, 'status' => 'On Track'],
    ['id' => 2, 'name' => 'Priya', 'task' => 'Database Security', 'progress' => 60, 'status' => 'In Progress'],
    ['id' => 3, 'name' => 'John', 'task' => 'API Documentation', 'progress' => 100, 'status' => 'Completed'],
    ['id' => 4, 'name' => 'Sarah', 'task' => 'User Auth Flow', 'progress' => 35, 'status' => 'Delayed'],
];
...
<head>
    ...
    <style>
        ...
        .tl-input, .tl-select, .tl-textarea { width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 6px; font-size: 14px; margin-top: 5px; }
            ...
            <div class="tl-dashboard">
                <div class="tl-header">
                    <div>
                        ...
                        <p style="font-size: 14px; color: #666; margin: 0;">Welcome back, <span style="color:#FF9B44; font-weight:bold;"><?= $tlProfile['name'] ?></span></p>
                    </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="immersive-row">
                                    ...
                                    <td class="immersive-cell"><span style="background:#f3f4f6; padding:6px 12px; border-radius:6px; font-size:12px; font-weight:600;"><i data-lucide="briefcase" size="14" style="vertical-align:middle; margin-right:5px; color:#FF9B44;"></i><?= $emp['task'] ?></span></td>
                                    ...
                                    <td class="immersive-cell">
                                        <span class="status-pill" style="background:<?= $styles['bg'] ?>; color:<?= $styles['text'] ?>; border:1px solid <?= $styles['border'] ?>;">
                                            <i data-lucide="clock" size="12"></i> <?= $emp['status'] ?>
                                        </span>
                                    </td>
                                    <td class="immersive-cell" style="text-align:right; padding-right:20px;">
                                        <div class="action-container">
                                            ...
                                            <div class="action-dropdown" id="dropdown-<?= $emp['id'] ?>">
                                                <a class="action-item" onclick="openActionModal('view', '<?= $emp['name'] ?>', '<?= $emp['task'] ?>')">
                                                    <i data-lucide="eye"></i> View Details
                                                </a>
                                                <a class="action-item" onclick="openActionModal('edit', '<?= $emp['name'] ?>', '<?= $emp['task'] ?>')">
                                                    <i data-lucide="edit-3"></i> Edit Task
                                                </a>
                                                <a class="action-item" onclick="openActionModal('review', '<?= $emp['name'] ?>', '<?= $emp['task'] ?>')">
                    ...
                    <div class="card-body">
                        <table class="review-table">
                            ...
                            <tbody id="reviewLogBody">
                                <tr id="noReviewPlaceholder"><td colspan="3" style="text-align:center; color:#999;">No reviews submitted yet</td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
